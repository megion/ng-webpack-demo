...
describe('HeroDetailComponent', () => {
  ...
  describe('with HeroModule setup', () => {
      ...
      void TestBed.configureTestingModule({
        ...
        .then(() => {
          ...
          jest
            ...
            .mockImplementation(() => firstValueFrom(of(true)))
        })
    }))
    ...
    it("cannot use `inject` to get component's provided HeroDetailService", () => {
      ...
      expect(
        inject(
          [HeroDetailService],
          (hds: HeroDetailService) => (service = hds),
        ),
  ...
  describe('when override its provided HeroDetailService', () => {
    ...
    beforeEach(waitForAsync(() => {
      void TestBed.configureTestingModule({
        ...
        .overrideComponent(HeroDetailComponent, {
          set: {
            providers: [
              { provide: HeroDetailService, useClass: HeroDetailServiceMock },
            ],
          },
        })
        .compileComponents()
    ...
    it("should display stub hero's name", () => {
      expect(page.nameDisplay.textContent).toBe(
        heroDetailsService.testHero.name,
      )
    })
  ...
  describe('with FormsModule setup', () => {
    ...
    it(// eslint-disable-next-line quotes
    "formsModuleSetup: should display 1st hero's name", waitForAsync(() => {
  ...
  describe('with SharedModule setup', () => {
    ...
    it(// eslint-disable-next-line quotes
    "sharedModuleSetup: should display 1st hero's name", waitForAsync(() => {
      const expectedHero = firstHero
      activatedRoute.setParamMap({ id: expectedHero.id })
      fixture = TestBed.createComponent(HeroDetailComponent)
      component = fixture.componentInstance
...
class Page {
  ...
  constructor(someFixture: ComponentFixture<HeroDetailComponent>) {
    const routerSpy = someFixture.debugElement.injector.get(
      Router,
    ) as unknown as {
